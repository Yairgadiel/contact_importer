(function () {
  ...
  const TEXTS = {
    ...
    results: {
      ...
      new_scan: 'סריקה חדשה',
      multi_hint: 'ב-iOS: 1) בלחיצה על "הוספה לאנשי קשר" בחרו "שמירה בקבצים" — האפשרות הראשונה ברשימה. 2) פתחו את הקובץ שנשמר — הוא בראש "גישה אחרונה". 3) שתפו אותו ל"אנשי קשר" ובחרו "הוסף את כל {n}".',
      multi_hint_wa: 'או בוואטסאפ: לחצו "שיתוף" ליד כל איש קשר, שלחו לעצמכם, פתחו את הקובץ בשיחה והוסיפו אותו.',
      share_contact: 'שיתוף',
    },
    config: {
      title: 'הגדרת שדות',
