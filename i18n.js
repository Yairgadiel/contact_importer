(function () {
  ...
  const TEXTS = {
    ...
    crop: {
      title: 'חיתוך התמונה',
      hint: 'גררו לבחירת אזור, קמצוץ להגדלה',
      zoom_in: 'הגדלה',
      zoom_out: 'הקטנה',
      card_ratio: 'יחס כרטיס',
      free: 'חופשי',
      cancel: 'בטל',
      confirm: 'אישור',
    },
    results: {
      ...
      new_scan: 'סריקה חדשה',
      multi_hint: '1) בלחיצה על "הוספה לאנשי קשר" בחרו "שמירה בקבצים" — האפשרות הראשונה ברשימה. 2) פתחו את הקובץ שנשמר — הוא בראש "גישה אחרונה". 3) שתפו אותו ל"אנשי קשר" ובחרו "הוסף את כל {n}".',
      multi_hint_wa: 'או בוואטסאפ: שתפו את הקובץ לעצמכם, פתחו אותו בשיחה והוסיפו את אנשי הקשר אחד אחד.',
      ios_label: 'הוראות ל-iOS',
    },
    config: {
      title: 'הגדרת שדות',
      close: 'סגירה',
